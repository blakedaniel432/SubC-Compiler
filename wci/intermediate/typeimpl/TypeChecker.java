...
public class TypeChecker {
	 ...
	 * 
	 * @param type
	 *            the type specification to check.
	 ...
	 * 
	 * @param type1
	 *            the first type specification to check.
	 * @param type2
	 *            the second type specification to check.
	...
	public static boolean isAtLeastOneReal(TypeSpec type1, TypeSpec type2) {
		return (isReal(type1) && isReal(type2)) || (isReal(type1) && isInteger(type2))
	...
	public static boolean areAssignmentCompatible(TypeSpec targetType, TypeSpec valueType) {
		...
		// string := string
			...
			compatible = targetType.isSubCString() && valueType.isSubCString();
		}
	...
	public static boolean areComparisonCompatible(TypeSpec type1, TypeSpec type2) {
		...
		// Two strings.
			...
			compatible = type1.isSubCString() && type2.isSubCString();
		}
