...
public enum SubCTokenType implements TokenType {
	...
	private static final int LAST_SPECIAL_INDEX = NOT.ordinal();
	...
	public static Hashtable<String, SubCTokenType> SPECIAL_SYMBOLS = new Hashtable<String, SubCTokenType>();
	static {
		SubCTokenType values[] = SubCTokenType.values();
