 ...
 *
 * <p>Parse a SubC array type specification.</p>
 *
...
class ArrayTypeParser extends TypeSpecificationParser
{
     ...
     */
    protected ArrayTypeParser(SubCParserTD parent)
    {
        super(parent);
    }

    // Synchronization set for the [ token.
    private static final EnumSet<SubCTokenType> LEFT_BRACKET_SET =
    ...
    // Synchronization set for the ] token.
    private static final EnumSet<SubCTokenType> RIGHT_BRACKET_SET =
        EnumSet.of(RIGHT_BRACKET, OF, SEMICOLON);

    // Synchronization set for OF.
    private static final EnumSet<SubCTokenType> OF_SET =
    ...
    /**
     * Parse a SubC array type specification.
    ...
    private static final EnumSet<SubCTokenType> INDEX_START_SET =
        SimpleTypeParser.SIMPLE_TYPE_START_SET.clone();
    static {
    ...
    private static final EnumSet<SubCTokenType> INDEX_END_SET =
        EnumSet.of(RIGHT_BRACKET, OF, SEMICOLON);

    // Synchronization set to follow an index type.
    private static final EnumSet<SubCTokenType> INDEX_FOLLOW_SET =
