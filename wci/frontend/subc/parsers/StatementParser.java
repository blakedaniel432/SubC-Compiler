...
public class StatementParser extends SubCParserTD {
	...
	protected static final EnumSet<SubCTokenType> STMT_START_SET = EnumSet.of(LEFT_BRACE, SubCTokenType.IF, WHILE,
	 ...
	 *             if an error occurred.
	 */
	protected void parseList(Token token, ICodeNode parentNode, SubCTokenType terminator, SubCErrorCode errorCode)
			throws Exception {
