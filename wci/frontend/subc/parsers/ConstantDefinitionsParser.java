 ...
 *
 * <p>
 * Parse SubC constant definitions.
 * </p>
 *
 * <p>
...
public class ConstantDefinitionsParser extends DeclarationsParser {
	...
	private static final EnumSet<SubCTokenType> IDENTIFIER_SET = DeclarationsParser.TYPE_START_SET.clone();
	static {
	...
	private static final EnumSet<SubCTokenType> EQUALS_SET = CONSTANT_START_SET.clone();
	static {
		EQUALS_SET.add(INT);
		EQUALS_SET.add(CHAR);
	...
	private static final EnumSet<SubCTokenType> NEXT_START_SET = DeclarationsParser.TYPE_START_SET.clone();
	static {
