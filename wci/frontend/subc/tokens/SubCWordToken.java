 ...
 *
 * <p>
 * SubC word tokens (identifiers and reserved words).
 * </p>
 *
 * <p>
...
public class SubCWordToken extends SubCToken {
	 ...
	 */
	public SubCWordToken(Source source) throws Exception {
		super(source);
	}
	...
	protected void extract() throws Exception {
		...
		type = (RESERVED_WORDS.contains(text)) ? SubCTokenType.valueOf(text.toUpperCase()) // reserved word
