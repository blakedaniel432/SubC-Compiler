...
public class Executor extends Backend {
	...
	static {
		...
		try {
			standardIn = new SubCScanner(new Source(new BufferedReader(new InputStreamReader(System.in))));
	...
	/**
	 * Execute the source program by processing the intermediate code and the symbol
	 * table stack generated by the parser.
	 * 
	 * @param iCode
