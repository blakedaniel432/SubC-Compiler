...
public class ProgramGenerator extends CodeGenerator {
	 ...
	 */
	public void generate(ICodeNode node) throws SubCCompilerException {
	...
	private void generateFields() {
		...
		emitDirective(FIELD_PRIVATE_STATIC, "_standardIn", "LSubCTextIn;");
	 ...
	 */
	private void generateRoutines() throws SubCCompilerException {
	 ...
	 */
	private void generateMainMethod() throws SubCCompilerException {
		emitBlankLine();
	...
	private void generateMainMethodPrologue() {
		...
		emit(NEW, "SubCTextIn");
		emit(DUP);
		emit(INVOKENONVIRTUAL, "SubCTextIn/<init>()V");
		emit(PUTSTATIC, programName + "/_standardIn LSubCTextIn;");
	 ...
	 */
	private void generateMainMethodCode() throws SubCCompilerException {
