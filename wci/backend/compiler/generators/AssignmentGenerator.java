...
public class AssignmentGenerator extends StatementGenerator {
	 ...
	 * @param nestingLevel
	 *            the nesting level of the target variable.
	 * @param exprNode
	...
	private void generateScalarAssignment(TypeSpec targetType, SymTabEntry targetId, ICodeNode lastModifier, int index,
		...
		} else if ((targetType == Predefined.charType) && (exprNode.getType() == STRING_CONSTANT)) {
	...
	/**
	 * Generate code to assign a SubC string value.
	 * 
	 * @param targetType
	 ...
	 */
	private void generateStringAssignment(TypeSpec targetType, ICodeNode exprNode, TypeSpec exprType,
		...
		// Truncate if necessary.
			...
			String substringRoutine = exprNode.getType() == STRING_CONSTANT ? STRING_SUBSTRING
