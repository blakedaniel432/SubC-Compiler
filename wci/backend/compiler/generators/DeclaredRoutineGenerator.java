...
public class DeclaredRoutineGenerator extends CodeGenerator {
	 ...
	 */
	public void generate(SymTabEntry routineId) throws SubCCompilerException {
	...
	private void generateRoutineLocals() {
		...
		for (SymTabEntry id : ids) {
			...
			if ((defn == VARIABLE) || (defn == VALUE_PARM) || (defn == VAR_PARM)) {
	 ...
	 */
	private void generateRoutineCode() throws SubCCompilerException {
