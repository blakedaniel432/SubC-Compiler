 ...
 *
 * <p>
 * Generate code to call a declared procedure or function.
 * </p>
 *
 * <p>
...
public class CallDeclaredGenerator extends CallGenerator {
	...
	/**
	 * Wrap an actual parameter to pass it by reference. in a procedure or function
	 * call.
	 * 
	 * @param actualNode
	 *            the parse tree node of the actual parameter.
	 * @param formalType
	 *            the type specification of the formal parameter
	 * @param wrapSlot
	 *            the slot number of the wrapper
	 * @param exprGenerator
	 *            the expression code generator.
	 */
	private void generateWrap(ICodeNode actualNode, TypeSpec formalType, int wrapSlot,
	...
	/**
	 * Clone an actual parameter value to be passed by value in a procedure or
	 * function call.
	 * 
	 * @param formalType
	 *            the type specification of the formal parameter
	 ...
	 * 
	 * @param actualId
	 *            the symbol table entry of the actual identifier.
	 * @param formalType
	 *            the type specification of the formal parameter
	 * @param programName
